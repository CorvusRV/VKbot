...
class VkTools:
    ...
    @staticmethod
    def formation_search_terms(params):
        """
        формирование условий поиска партнера
        """
    ...
    def city_id(self, name):
        """
        определение индетификатора города
        """
        name = name.split(', ')
